...
(function () {
  ...
  const T = {
    en: {'about-title': 'About ALTARYX', 'about-text': `ALTARYX is a technological digital asset for the new generation of DeFi users.<br>
    ...
    ru: {'about-title': 'О ALTARYX', 'about-text': `ALTARYX — технологичный цифровой актив для нового поколения пользователей DeFi.<br>
